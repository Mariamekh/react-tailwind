...
export function SortDropdown() {
  ...
  return (
    <Dropdown
      align="right"
      triggerClassName="h-10 w-[164px] gap-0 justify-between rounded-lg border border-surface-border py-2 pl-3 pr-2 font-sailec text-[12px] font-medium leading-none text-ink-700"
