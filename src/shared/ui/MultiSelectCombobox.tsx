...
export function MultiSelectCombobox({
  ...
  return (
    <Dropdown
      fullWidth
      triggerClassName={cn(
        'h-10 w-full justify-between rounded-lg border-surface-border2 py-3 pl-3 pr-2 font-sailec text-[13px] font-medium leading-none text-ink-600 min-[1099px]:w-[202px]',
